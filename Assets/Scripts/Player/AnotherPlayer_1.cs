...
public class AnotherPlayer_1 : Player
{
    Factory1 factory1;
    ...
    private void ExecuteAttack2(int element, int index)
    {
        switch (element)
        {
            ...
            case 0:
                ...
                {
                    case 0:
                        factory1.GetStone_01(this.gameObject.transform.position);
                        break;
                    case 1:
                        factory1.GetStone_02(this.gameObject.transform.position);
                        break;
                    case 2:
                        factory1.GetStone_03(this.gameObject.transform.position);
                        break;
                    case 3:
                        factory1.GetStone_04(this.gameObject.transform.position);
                        break;
                    case 4:
                        factory1.GetStone_05(this.gameObject.transform.position);
                        break;
                    default:
                        break;
                }
            ...
            case 1:
                ...
                {
                    case 0:
                        factory1.GetFire_01(this.gameObject.transform.position);
                        break;
                    case 1:
                        factory1.GetFire_02(this.gameObject.transform.position);
                        break;
                    case 2:
                        factory1.GetFire_03(this.gameObject.transform.position);
                        break;
                    case 3:
                        factory1.GetFire_04(this.gameObject.transform.position);
                        break;
                    case 4:
                        factory1.GetFire_05(this.gameObject.transform.position);
                        break;
                    default:
                        break;
                }
            ...
            case 2:
                ...
                {
                    case 0:
                        factory1.GetWater_01(this.gameObject.transform.position);
                        break;
                    case 1:
                        factory1.GetWater_02(this.gameObject.transform.position);
                        break;
                    case 2:
                        factory1.GetWater_03(this.gameObject.transform.position);
                        break;
                    case 3:
                        factory1.GetWater_04(this.gameObject.transform.position);
                        break;
                    case 4:
                        factory1.GetWater_05(this.gameObject.transform.position);
                        break;
                    default:
                        break;
                }
